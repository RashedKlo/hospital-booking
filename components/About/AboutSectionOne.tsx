...
const AboutSectionOne = () => {
  ...
  return (
    <section id="about" className="pt-16 md:pt-20 lg:pt-28" dir="rtl">
              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="أطباء ذوو خبرة عالية" />
                    <List text="أحدث المعدات الطبية" />
                    <List text="خدمة متاحة 24/7" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="حجز فوري ومباشر" />
                    <List text="رعاية صحية شاملة" />
                    <List text="أسعار تنافسية" />
                  </div>
                </div>
              </div>
            </div>
