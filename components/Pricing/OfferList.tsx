...
const OfferList = ({
  ...
  return (
    <div className="mb-3 flex items-center" dir="rtl">
      <span className="ml-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-primary bg-opacity-10 text-primary">
